...
const getSortedUniqueSkills = (users) =>
  users
    //создаем массив allSkills( он пустой сначала), используем ключ skills.
    // в ...allSkills рестим skills
    .reduce((allSkills, { skills }) => [...allSkills, ...skills], [])
    // оставляем елементы с одним индексом
    .filter((elementSkills, i, skills) => skills.indexOf(elementSkills) === i)
